...
namespace WAFC.Reports
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            var exportBundle = new Bundle("~/bundles/export");
            exportBundle.Include(
                  "~/assets/js/jquery.table2excel.js");
            exportBundle.Builder = nullBuilder;
            exportBundle.Transforms.Add(scriptTransformer);
            exportBundle.Orderer = nullOrderer;
            bundles.Add(exportBundle);
