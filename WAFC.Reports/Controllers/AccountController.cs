    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (model.Photo != null)
                {
                    path = Server.MapPath("~/assets/img/avatars/");
                    filePath = path + Path.GetFileName(model.Photo.FileName);
                    model.Photo.SaveAs(filePath);
                    filePath = "/APH/assets/img/avatars/" + model.Photo.FileName;
                }
                else
                {
                    filePath = "/APH/assets/img/avatars/100_1.jpg";
                }
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, Photo = filePath };
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Themes", "Reports");
                }
                AddErrors(result);
            }
